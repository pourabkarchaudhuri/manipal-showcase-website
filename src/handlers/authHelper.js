...
var clientId = config.configuration.microsoftAppRegistrationPortal.clientId;
var clientSecret = config.configuration.microsoftAppRegistrationPortal.clientSecret;
var redirectUri = config.configuration.microsoftAppRegistrationPortal.redirectUri;

var scopes = config.configuration.oauthScope;

var credentials = {
  clientID: clientId,
  clientSecret: clientSecret,
  site: config.configuration.token.site,
  authorizationPath: config.configuration.token.authorizationPath,
  tokenPath: config.configuration.token.tokenPath
}
